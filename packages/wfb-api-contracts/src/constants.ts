...
export enum ApiName {
    GET_WORKSPACE_TEMPLATE_LIST = 'GetWorkspaceTemplateList',
    GET_WORKSPACE_TEMPLATE = 'GetWorkspaceTemplate',
    GET_SERVICE_CATEGORY_LIST = 'GetServiceCategoryList',
    GET_SERVICE_CATEGORY_ITEM_LIST = 'GetServiceCategoryItemList',
    CREATE_SERVICE_CATEGORY = 'CreateServiceCategory',
}
